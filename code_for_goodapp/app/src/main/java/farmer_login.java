...
public class farmer_login extends AppCompatActivity implements View.OnClickListener {
    ...
    public void adminLogin()
    {
        ...
        progressDialog.show();
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, Constants.Admin_LOGIN+"?password="+password+"&userid="+userid , null,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if(!response.getBoolean("error")) {
                                ...
                                Intent i = new Intent(getApplicationContext(), time_picker.class);
                                startActivity(i);
                                finish();
                            }
                            else
